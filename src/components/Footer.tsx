        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/delivery" className="text-gray-600 hover:text-primary-600">
                  {t('footer.services.delivery')}
                </Link>
              </li>
              <li>
                <Link to="/takeaway" className="text-gray-600 hover:text-primary-600">
                  {t('footer.services.takeaway')}
                </Link>
              </li>
            </ul>
          </div>
