const Footer = () => {
  return (
    <footer className="bg-indigo-100 mt-auto">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">À propos</h3>
            <p className="text-gray-600">
              Location de voitures de luxe pour tous vos besoins. Service premium et véhicules d'exception.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/cars" className="text-gray-600 hover:text-primary-600">Nos véhicules</a></li>
              <li><a href="/services" className="text-gray-600 hover:text-primary-600">Services</a></li>
              <li><a href="/about" className="text-gray-600 hover:text-primary-600">À propos</a></li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center">
          <p className="text-gray-600">© 2024 Wael Le Boss. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
